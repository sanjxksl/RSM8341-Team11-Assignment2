...
On average, the portfolio gains \$38.0M over one year, driven by coupon income and the tendency for rates to drift toward $\theta = 4\%$ (which pushes bond prices up). However, the distribution exhibits a meaningful left tail: the 95\% VaR of \$52.5M and 99\% VaR of \$94.8M indicate that in adverse rate scenarios, the portfolio can suffer substantial losses. The distribution is \textbf{negatively skewed} (sample skewness $\approx -0.46$): the left tail extends out to roughly $-\$191$M, while the right tail is bounded near $+\$159$M. This asymmetry reflects the economics of a long-bond portfolio. Small or moderate rate movements are common and produce modest gains or losses, but large adverse rate increases, though less likely under mean reversion than they would be under a symmetric Gaussian model, still translate into outsized mark-to-market losses because of the convex (and locally quasi-linear) repricing of long-duration bonds. Favorable rate \emph{decreases} do produce gains, but those gains are bounded by the fact that the coupon and principal cash flows are fixed in nominal terms, capping how far the portfolio can appreciate.
